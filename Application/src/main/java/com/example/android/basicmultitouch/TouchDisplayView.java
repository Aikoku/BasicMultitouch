...
//                data.label = "id: " + 0;
                ...
                data.label = "("+event.getX()+":"+event.getY()+")";
                /*
    ...
    private static final float CIRCLE_RADIUS_DP = 75f/2;
    // radius of historical circle in dp
    private static final float CIRCLE_HISTORICAL_RADIUS_DP = 7f*2;
    ...
    public final int[] COLORS = {
            Color.RED, Color.GREEN, 0xFF99CC00, 0xFFFFBB33, 0xFFFF4444,
